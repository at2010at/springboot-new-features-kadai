...
-- レビューテーブル kadai2
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (1, 1, 1, '太郎', 5, '素晴らしい滞在でした。また利用したいです。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (2, 1, 2, '花子', 4, '部屋が綺麗で、快適に過ごせました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (3, 1, 3, '田中', 4, 'アクセスが良く、観光に最適でした。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (4, 1, 4, '山田', 5, 'スタッフが親切で、気持ちよく滞在できました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (5, 1, 5, '加藤', 4, '駅から近く、便利でした。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (6, 1, 6, '佐藤', 5, '周辺の飲食店が充実していて、楽しめました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (7, 1, 7, '伊藤', 4, '宿泊費が手頃で、コストパフォーマンスが良かったです。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (8, 1, 8, '鬼頭', 3, '静かな環境でゆっくり休めました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (9, 1, 9, '内藤', 4, '施設内の設備が充実していました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (10, 1, 10, '鈴木', 5, 'Wi-Fiが快適で助かりました。');
INSERT IGNORE INTO reviews (id, house_id, user_id, name, star, review_comment) VALUES (11, 1, 11, '後藤', 4, '清潔感があり、気持ちよく滞在できました。');
